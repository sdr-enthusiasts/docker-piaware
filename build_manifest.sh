...
docker pull mikenye/piaware:${VERSION}-arm64v8
...
docker manifest annotate mikenye/piaware:${VERSION} mikenye/piaware:${VERSION}-arm64v8 --os linux --arch arm64 --variant v8
...
docker manifest annotate mikenye/piaware:latest mikenye/piaware:${VERSION}-arm64v8 --os linux --arch arm64 --variant v8
